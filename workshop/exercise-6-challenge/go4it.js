// known bug: when ai is present, wrong player number is sometimes declared the winner.  probably has to do with timing
// some diagonal win conditions are not working?  :(
...
const beginGameFunctions = function(){
    ...
    const matchStart = function() {
        ...
        if (turnOne === true && players.playerTwo.species === 'ai') {
            const aiWaitFunction = function() {
                if (players.playerTwo.color != 'unkown') {
                    clearInterval(aiWaitForcolors);
                    updatePlayerTurn();
                }
            }
                const aiWaitForcolors = setInterval(aiWaitFunction, 100);
        }
        else updatePlayerTurn();                       // DONE: updates h1's text to inform user(s) whose turn it is
    ...
    const testWin = function(){                              
        ...
        if (grid.column1[0]===grid.column1[1] && grid.column1[1]===grid.column1[2] && grid.column1[2]===grid.column1[3] && grid.column1[3] != '1'){gameOver = true;}
        else if (grid.column1[4]===grid.column1[1] && grid.column1[1]===grid.column1[2] && grid.column1[2]===grid.column1[3] && grid.column1[3] != '1'){gameOver = true;}
        else if (grid.column1[4]===grid.column1[5] && grid.column1[5]===grid.column1[2] && grid.column1[2]===grid.column1[3] && grid.column1[3] != '1'){gameOver = true;}
        else if (grid.column1[4]===grid.column1[5] && grid.column1[5]===grid.column1[6] && grid.column1[6]===grid.column1[3] && grid.column1[3] != '1'){gameOver = true;}
        else if (grid.column1[4]===grid.column1[5] && grid.column1[5]===grid.column1[6] && grid.column1[6]===grid.column1[7] && grid.column1[7] != '1'){gameOver = true;}

        else if (grid.column2[0]===grid.column2[1] && grid.column2[1]===grid.column2[2] && grid.column2[2]===grid.column2[3] && grid.column2[3] != '1'){gameOver = true;}
        else if (grid.column2[4]===grid.column2[1] && grid.column2[1]===grid.column2[2] && grid.column2[2]===grid.column2[3] && grid.column2[3] != '1'){gameOver = true;}
        else if (grid.column2[4]===grid.column2[5] && grid.column2[5]===grid.column2[2] && grid.column2[2]===grid.column2[3] && grid.column2[3] != '1'){gameOver = true;}
        else if (grid.column2[4]===grid.column2[5] && grid.column2[5]===grid.column2[6] && grid.column2[6]===grid.column2[3] && grid.column2[3] != '1'){gameOver = true;}
        else if (grid.column2[4]===grid.column2[5] && grid.column2[5]===grid.column2[6] && grid.column2[6]===grid.column2[7] && grid.column2[7] != '1'){gameOver = true;}

        else if (grid.column3[0]===grid.column3[1] && grid.column3[1]===grid.column3[2] && grid.column3[2]===grid.column3[3] && grid.column3[3] != '1'){gameOver = true;}
        else if (grid.column3[4]===grid.column3[1] && grid.column3[1]===grid.column3[2] && grid.column3[2]===grid.column3[3] && grid.column3[3] != '1'){gameOver = true;}
        else if (grid.column3[4]===grid.column3[5] && grid.column3[5]===grid.column3[2] && grid.column3[2]===grid.column3[3] && grid.column3[3] != '1'){gameOver = true;}
        else if (grid.column3[4]===grid.column3[5] && grid.column3[5]===grid.column3[6] && grid.column3[6]===grid.column3[3] && grid.column3[3] != '1'){gameOver = true;}
        else if (grid.column3[4]===grid.column3[5] && grid.column3[5]===grid.column3[6] && grid.column3[6]===grid.column3[7] && grid.column3[7] != '1'){gameOver = true;}

        else if (grid.column4[0]===grid.column4[1] && grid.column4[1]===grid.column4[2] && grid.column4[2]===grid.column4[3] && grid.column4[3] != '1'){gameOver = true;}
        else if (grid.column4[4]===grid.column4[1] && grid.column4[1]===grid.column4[2] && grid.column4[2]===grid.column4[3] && grid.column4[3] != '1'){gameOver = true;}
        else if (grid.column4[4]===grid.column4[5] && grid.column4[5]===grid.column4[2] && grid.column4[2]===grid.column4[3] && grid.column4[3] != '1'){gameOver = true;}
        else if (grid.column4[4]===grid.column4[5] && grid.column4[5]===grid.column4[6] && grid.column4[6]===grid.column4[3] && grid.column4[3] != '1'){gameOver = true;}
        else if (grid.column4[4]===grid.column4[5] && grid.column4[5]===grid.column4[6] && grid.column4[6]===grid.column4[7] && grid.column4[7] != '1'){gameOver = true;}

        else if (grid.column5[0]===grid.column5[1] && grid.column5[1]===grid.column5[2] && grid.column5[2]===grid.column5[3] && grid.column5[3] != '1'){gameOver = true;}
        else if (grid.column5[4]===grid.column5[1] && grid.column5[1]===grid.column5[2] && grid.column5[2]===grid.column5[3] && grid.column5[3] != '1'){gameOver = true;}
        else if (grid.column5[4]===grid.column5[5] && grid.column5[5]===grid.column5[2] && grid.column5[2]===grid.column5[3] && grid.column5[3] != '1'){gameOver = true;}
        else if (grid.column5[4]===grid.column5[5] && grid.column5[5]===grid.column5[6] && grid.column5[6]===grid.column5[3] && grid.column5[3] != '1'){gameOver = true;}
        else if (grid.column5[4]===grid.column5[5] && grid.column5[5]===grid.column5[6] && grid.column5[6]===grid.column5[7] && grid.column5[7] != '1'){gameOver = true;}

        else if (grid.column6[0]===grid.column6[1] && grid.column6[1]===grid.column6[2] && grid.column6[2]===grid.column6[3] && grid.column6[3] != '1'){gameOver = true;}
        else if (grid.column6[4]===grid.column6[1] && grid.column6[1]===grid.column6[2] && grid.column6[2]===grid.column6[3] && grid.column6[3] != '1'){gameOver = true;}
        else if (grid.column6[4]===grid.column6[5] && grid.column6[5]===grid.column6[2] && grid.column6[2]===grid.column6[3] && grid.column6[3] != '1'){gameOver = true;}
        else if (grid.column6[4]===grid.column6[5] && grid.column6[5]===grid.column6[6] && grid.column6[6]===grid.column6[3] && grid.column6[3] != '1'){gameOver = true;}
        else if (grid.column6[4]===grid.column6[5] && grid.column6[5]===grid.column6[6] && grid.column6[6]===grid.column6[7] && grid.column6[7] != '1'){gameOver = true;}

        else if (grid.column7[0]===grid.column7[1] && grid.column7[1]===grid.column7[2] && grid.column7[2]===grid.column7[3] && grid.column7[3] != '1'){gameOver = true;}
        else if (grid.column7[4]===grid.column7[1] && grid.column7[1]===grid.column7[2] && grid.column7[2]===grid.column7[3] && grid.column7[3] != '1'){gameOver = true;}
        else if (grid.column7[4]===grid.column7[5] && grid.column7[5]===grid.column7[2] && grid.column7[2]===grid.column7[3] && grid.column7[3] != '1'){gameOver = true;}
        else if (grid.column7[4]===grid.column7[5] && grid.column7[5]===grid.column7[6] && grid.column7[6]===grid.column7[3] && grid.column7[3] != '1'){gameOver = true;}
        else if (grid.column7[4]===grid.column7[5] && grid.column7[5]===grid.column7[6] && grid.column7[6]===grid.column7[7] && grid.column7[7] != '1'){gameOver = true;}
        
        //all row posibilities
        else if (grid.column1[0]===grid.column2[0] && grid.column3[0]===grid.column4[0] && grid.column2[0]===grid.column3[0] && grid.column3[0] != '1'){gameOver = true;}
        else if (grid.column5[0]===grid.column2[0] && grid.column3[0]===grid.column4[0] && grid.column2[0]===grid.column3[0] && grid.column3[0] != '1'){gameOver = true;}
        else if (grid.column5[0]===grid.column6[0] && grid.column3[0]===grid.column4[0] && grid.column6[0]===grid.column3[0] && grid.column3[0] != '1'){gameOver = true;}
        else if (grid.column5[0]===grid.column6[0] && grid.column7[0]===grid.column4[0] && grid.column6[0]===grid.column7[0] && grid.column7[0] != '1'){gameOver = true;}

        else if (grid.column1[1]===grid.column2[1] && grid.column3[1]===grid.column4[1] && grid.column2[1]===grid.column3[1] && grid.column3[1] != '1'){gameOver = true;}
        else if (grid.column5[1]===grid.column2[1] && grid.column3[1]===grid.column4[1] && grid.column2[1]===grid.column3[1] && grid.column3[1] != '1'){gameOver = true;}
        else if (grid.column5[1]===grid.column6[1] && grid.column3[1]===grid.column4[1] && grid.column6[1]===grid.column3[1] && grid.column3[1] != '1'){gameOver = true;}
        else if (grid.column5[1]===grid.column6[1] && grid.column7[1]===grid.column4[1] && grid.column6[1]===grid.column7[1] && grid.column7[1] != '1'){gameOver = true;}

        else if (grid.column1[2]===grid.column2[2] && grid.column3[2]===grid.column4[2] && grid.column2[2]===grid.column3[2] && grid.column3[2] != '1'){gameOver = true;}
        else if (grid.column5[2]===grid.column2[2] && grid.column3[2]===grid.column4[2] && grid.column2[2]===grid.column3[2] && grid.column3[2] != '1'){gameOver = true;}
        else if (grid.column5[2]===grid.column6[2] && grid.column3[2]===grid.column4[2] && grid.column6[2]===grid.column3[2] && grid.column3[2] != '1'){gameOver = true;}
        else if (grid.column5[2]===grid.column6[2] && grid.column7[2]===grid.column4[2] && grid.column6[2]===grid.column7[2] && grid.column7[2] != '1'){gameOver = true;}

        else if (grid.column1[3]===grid.column2[3] && grid.column3[3]===grid.column4[3] && grid.column2[3]===grid.column3[3] && grid.column3[3] != '1'){gameOver = true;}
        else if (grid.column5[3]===grid.column2[3] && grid.column3[3]===grid.column4[3] && grid.column2[3]===grid.column3[3] && grid.column3[3] != '1'){gameOver = true;}
        else if (grid.column5[3]===grid.column6[3] && grid.column3[3]===grid.column4[3] && grid.column6[3]===grid.column3[3] && grid.column3[3] != '1'){gameOver = true;}
        else if (grid.column5[3]===grid.column6[3] && grid.column7[3]===grid.column4[3] && grid.column6[3]===grid.column7[3] && grid.column7[3] != '1'){gameOver = true;}

        else if (grid.column1[4]===grid.column2[4] && grid.column3[4]===grid.column4[4] && grid.column2[4]===grid.column3[4] && grid.column3[4] != '1'){gameOver = true;}
        else if (grid.column5[4]===grid.column2[4] && grid.column3[4]===grid.column4[4] && grid.column2[4]===grid.column3[4] && grid.column3[4] != '1'){gameOver = true;}
        else if (grid.column5[4]===grid.column6[4] && grid.column3[4]===grid.column4[4] && grid.column6[4]===grid.column3[4] && grid.column3[4] != '1'){gameOver = true;}
        else if (grid.column5[4]===grid.column6[4] && grid.column7[4]===grid.column4[4] && grid.column6[4]===grid.column7[4] && grid.column7[4] != '1'){gameOver = true;}

        else if (grid.column1[5]===grid.column2[5] && grid.column3[5]===grid.column4[5] && grid.column2[5]===grid.column3[5] && grid.column3[5] != '1'){gameOver = true;}
        else if (grid.column5[5]===grid.column2[5] && grid.column3[5]===grid.column4[5] && grid.column2[5]===grid.column3[5] && grid.column3[5] != '1'){gameOver = true;}
        else if (grid.column5[5]===grid.column6[5] && grid.column3[5]===grid.column4[5] && grid.column6[5]===grid.column3[5] && grid.column3[5] != '1'){gameOver = true;}
        else if (grid.column5[5]===grid.column6[5] && grid.column7[5]===grid.column4[5] && grid.column6[5]===grid.column7[5] && grid.column7[5] != '1'){gameOver = true;}

        // / diagonals
        else if (grid.column1[3]===grid.column2[2] && grid.column3[1]===grid.column4[0] && grid.column2[2]===grid.column3[1] && grid.column3[1] != '1'){gameOver = true;}
        else if (grid.column1[4]===grid.column2[3] && grid.column3[2]===grid.column4[1] && grid.column2[3]===grid.column3[2] && grid.column3[2] != '1'){gameOver = true;}
        else if (grid.column5[0]===grid.column2[3] && grid.column3[2]===grid.column4[1] && grid.column2[3]===grid.column3[2] && grid.column3[2] != '1'){gameOver = true;}
        else if (grid.column1[5]===grid.column2[4] && grid.column3[3]===grid.column4[2] && grid.column2[4]===grid.column3[3] && grid.column3[3] != '1'){gameOver = true;}
        else if (grid.column5[1]===grid.column2[4] && grid.column3[3]===grid.column4[2] && grid.column2[4]===grid.column3[3] && grid.column3[3] != '1'){gameOver = true;}
        else if (grid.column5[1]===grid.column6[0] && grid.column3[3]===grid.column4[2] && grid.column6[0]===grid.column3[3] && grid.column3[3] != '1'){gameOver = true;}
        else if (grid.column5[2]===grid.column2[5] && grid.column3[4]===grid.column4[3] && grid.column2[5]===grid.column3[4] && grid.column3[4] != '1'){gameOver = true;}
        else if (grid.column5[2]===grid.column6[1] && grid.column3[4]===grid.column4[3] && grid.column6[1]===grid.column3[4] && grid.column3[4] != '1'){gameOver = true;}
        else if (grid.column5[2]===grid.column6[1] && grid.column7[0]===grid.column4[3] && grid.column6[1]===grid.column7[0] && grid.column7[0] != '1'){gameOver = true;}
        else if (grid.column5[3]===grid.column6[2] && grid.column3[5]===grid.column4[4] && grid.column6[2]===grid.column3[5] && grid.column3[5] != '1'){gameOver = true;}
        else if (grid.column5[3]===grid.column6[2] && grid.column7[1]===grid.column4[4] && grid.column6[2]===grid.column7[1] && grid.column7[1] != '1'){gameOver = true;}
        else if (grid.column5[4]===grid.column6[3] && grid.column7[2]===grid.column4[5] && grid.column6[3]===grid.column7[2] && grid.column7[2] != '1'){gameOver = true;}

        // \ diagonals
        else if (grid.column7[3]===grid.column6[2] && grid.column5[1]===grid.column4[0] && grid.column6[2]===grid.column5[1] && grid.column5[1] != '1'){gameOver = true;}
        else if (grid.column7[4]===grid.column6[3] && grid.column5[2]===grid.column4[1] && grid.column6[3]===grid.column5[2] && grid.column5[2] != '1'){gameOver = true;}
        else if (grid.column3[0]===grid.column6[3] && grid.column5[2]===grid.column4[1] && grid.column6[3]===grid.column5[2] && grid.column5[2] != '1'){gameOver = true;}
        else if (grid.column7[5]===grid.column6[4] && grid.column5[3]===grid.column4[2] && grid.column6[4]===grid.column5[3] && grid.column5[3] != '1'){gameOver = true;}
        else if (grid.column3[1]===grid.column6[4] && grid.column5[3]===grid.column4[2] && grid.column6[4]===grid.column5[3] && grid.column5[3] != '1'){gameOver = true;}
        else if (grid.column3[1]===grid.column2[0] && grid.column5[3]===grid.column4[2] && grid.column2[0]===grid.column5[3] && grid.column5[3] != '1'){gameOver = true;}
        else if (grid.column3[2]===grid.column6[5] && grid.column5[4]===grid.column4[3] && grid.column6[5]===grid.column5[4] && grid.column5[4] != '1'){gameOver = true;}
        else if (grid.column3[2]===grid.column2[1] && grid.column5[4]===grid.column4[3] && grid.column2[1]===grid.column5[4] && grid.column5[4] != '1'){gameOver = true;}
        else if (grid.column3[2]===grid.column2[1] && grid.column1[0]===grid.column4[3] && grid.column2[1]===grid.column1[0] && grid.column1[0] != '1'){gameOver = true;}
        else if (grid.column3[3]===grid.column2[2] && grid.column5[5]===grid.column4[4] && grid.column2[2]===grid.column5[5] && grid.column5[5] != '1'){gameOver = true;}
        else if (grid.column3[3]===grid.column2[2] && grid.column1[1]===grid.column4[4] && grid.column2[2]===grid.column1[1] && grid.column1[1] != '1'){gameOver = true;}
        else if (grid.column3[4]===grid.column2[3] && grid.column1[2]===grid.column4[5] && grid.column2[3]===grid.column1[2] && grid.column1[2] != '1'){gameOver = true;}
        ...
        if (gameOver){
            arrows.forEach(element => {element.removeEventListener('click', addchip);});
            // arrow1.removeEventListener('click', addchip);
            // arrow2.removeEventListener('click', addchip);
            // arrow3.removeEventListener('click', addchip);
            // arrow4.removeEventListener('click', addchip);
            ...
            if (players.playerTwo.species === 'ai') {
                // console.log(activePlayer);
                activePlayerSwap();
                // console.log(activePlayer);
                // console.log('swap test');
            }
            activePlayerSwap(); h1.innerText = `${activePlayer} has won!`;
